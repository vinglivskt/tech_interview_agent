...
- Name: full-flow.spec.ts >> Chat mode >> loads random question and shows question number
- Location: tests/e2e/full-flow.spec.ts:64:3
...
Call log:
  ...
  - waiting for locator('text=Вопрос №—')
    24 × locator resolved to <div class="_questionBadge_lvxwa_27">Вопрос №—</div>
