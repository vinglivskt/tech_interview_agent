...
- Name: full-flow.spec.ts >> Home page >> stats overview button opens stats view
- Location: tests/e2e/full-flow.spec.ts:46:3
...
Locator: getByText('test_e2e_user')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('test_e2e_user')
...
- banner:
  - button "← Назад"
  - heading "📊 Статистика ответов — Все режимы" [level=1]
- paragraph: ⚠️ Unknown error
```
