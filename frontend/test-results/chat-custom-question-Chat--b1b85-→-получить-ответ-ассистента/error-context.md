...
- Name: chat-custom-question.spec.ts >> Chat: Задать свой вопрос >> полный flow: задать вопрос → получить ответ ассистента
- Location: tests/e2e/chat-custom-question.spec.ts:68:3
