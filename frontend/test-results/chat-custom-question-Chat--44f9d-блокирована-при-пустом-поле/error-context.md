...
- Name: chat-custom-question.spec.ts >> Chat: Задать свой вопрос >> кнопка «Получить ответ» заблокирована при пустом поле
- Location: tests/e2e/chat-custom-question.spec.ts:49:3
