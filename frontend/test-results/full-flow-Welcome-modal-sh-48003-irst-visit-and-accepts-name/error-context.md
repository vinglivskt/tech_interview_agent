...
- generic [ref=e2]:
  - dialog [ref=e3]:
    - button "Переключить тему" [ref=e5] [cursor=pointer]
    - generic [ref=e15]:
      - generic [ref=e16]: 🐍
      - heading "Python Interview Assistant" [level=1] [ref=e17]
      - paragraph [ref=e18]: Личный помощник для подготовки к собеседованиям по Python.
      - paragraph [ref=e19]: Чтобы мы могли сохранять вашу статистику ответов между сессиями — представьтесь. Это нужно для того, чтобы вы могли вернуться и посмотреть, над какими темами стоит поработать ещё.
      - generic [ref=e20]:
        - generic [ref=e21]: Ваше имя
        - textbox "Ваше имя" [active] [ref=e22]:
          - /placeholder: Например, Алексей
        - button "Начать" [ref=e23] [cursor=pointer]
      - paragraph [ref=e24]: Имя используется только как ключ для группировки ваших ответов. Без пароля и регистрации.
  - generic [ref=e25]:
    - generic [ref=e26]:
      - generic [ref=e27]: 🐍
      - button "Переключить тему" [ref=e28] [cursor=pointer]
    - generic [ref=e38]:
      - generic [ref=e39]:
        - heading "Python Interview Assistant" [level=1] [ref=e40]
        - paragraph [ref=e41]: Выберите режим работы
      - generic [ref=e42]:
        - generic [ref=e43] [cursor=pointer]:
          - generic [ref=e44]: 💬
          - heading "Интервью" [level=3] [ref=e45]
          - paragraph [ref=e46]: Свободный диалог с ассистентом. Задавайте вопросы, получайте ответы с ссылками на базу знаний.
        - generic [ref=e47] [cursor=pointer]:
          - generic [ref=e48]: 📝
          - heading "Тестирование" [level=3] [ref=e49]
          - paragraph [ref=e50]: 20 вопросов с вариантами ответов. Проверьте свои знания и узнайте свой уровень.
        - generic [ref=e51] [cursor=pointer]:
          - generic [ref=e52]: 🎯
          - heading "Собеседование" [level=3] [ref=e53]
          - paragraph [ref=e54]: 15–25 вопросов по темам, свободные ответы, оценка в процентах и финальный вердикт.
        - generic [ref=e55] [cursor=pointer]:
          - generic [ref=e56]: 🏗️
          - heading "Системный дизайн" [level=3] [ref=e57]
          - paragraph [ref=e58]: Проектируйте систему пошагово и получите оценку по архитектурной рубрике.
```
