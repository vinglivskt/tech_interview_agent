...
- Name: chat-custom-question.spec.ts >> Chat: Задать свой вопрос >> кнопка «Задать свой вопрос» отображается на экране
- Location: tests/e2e/chat-custom-question.spec.ts:32:3
